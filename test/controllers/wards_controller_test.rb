...
class WardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ward" do
    assert_difference('Ward.count') do
      post wards_url, params: { ward: { hname: @ward.hname, wardno: @ward.wardno, wname: @ward.wname } }
    end
  ...
  test "should update ward" do
    patch ward_url(@ward), params: { ward: { hname: @ward.hname, wardno: @ward.wardno, wname: @ward.wname } }
