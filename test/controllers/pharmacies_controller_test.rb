...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post pharmacies_url, params: { pharmacy: { hname: @pharmacy.hname, pharmacyno: @pharmacy.pharmacyno, pname: @pharmacy.pname, wardno: @pharmacy.wardno } }
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { hname: @pharmacy.hname, pharmacyno: @pharmacy.pharmacyno, pname: @pharmacy.pname, wardno: @pharmacy.wardno } }
